#ifndef DOTA2D_BUILDING_PILLAR_HEADER
#define DOTA2D_BUILDING_PILLAR_HEADER
...
namespace dota2d
{
  ...
  {
    public:
      Pillar(int _hp ,int _max_hp ,float _hp_regen ,float _physical_rasistant ,float _magical_rasistant,
