...
void dota2d::SideBuildings::init_dire()
{
  ...
  //baracks middle
  m_middle_melee_barracks = new Barracks(1500, 1500, 0.5, 50, 0, TeamSide::Dire, ASSEST_BUILDING_MELEE_BARRACKS_DIRE, sf::Vector2f(650, 650));
  m_middle_ranged_barracks =  new Barracks(2000, 2000, 0.5, 50, 0, TeamSide::Dire, ASSEST_BUILDING_RANGED_BARRACKS_DIRE, sf::Vector2f(650, 700));;
  ...
  //top towers
  m_top_1_tower = new Tower(100, 10, 1, 1, 1100, 1100, 1.0, 10,0, TeamSide::Dire, ASSEST_BUILDING_RANGED_TOWER_DIRE, sf::Vector2f(100, 100));
  m_top_2_tower = new Tower(100, 10, 1, 1, 1200, 1200, 1.0, 10,0, TeamSide::Dire, ASSEST_BUILDING_RANGED_TOWER_DIRE, sf::Vector2f(300, 100));
  ...
  //middle towers
  m_middle_1_tower = new Tower(100, 10, 1, 1, 2100, 2100, 1.0, 10,0, TeamSide::Dire, ASSEST_BUILDING_RANGED_TOWER_DIRE, sf::Vector2f(1000, 1000));
  m_middle_2_tower = new Tower(100, 10, 1, 1, 2200, 2200, 1.0, 10,0, TeamSide::Dire, ASSEST_BUILDING_RANGED_TOWER_DIRE, sf::Vector2f(800, 800));
  m_middle_3_tower = new Tower(100, 10, 1, 1, 2300, 2300, 1.0, 10,0, TeamSide::Dire, ASSEST_BUILDING_RANGED_TOWER_DIRE, sf::Vector2f(600, 600));
